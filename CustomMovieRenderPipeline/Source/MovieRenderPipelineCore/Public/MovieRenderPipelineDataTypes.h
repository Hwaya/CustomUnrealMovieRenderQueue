...
namespace MoviePipeline
{
	...
	*/
	...
	public:
		...
		float PrevDistanceOfEyes;
		float PrevDistanceOfFocus;
		bool PrevbUseFocus;
	};
...
namespace MoviePipeline
{
	...
	struct MOVIERENDERPIPELINECORE_API FMoviePipelineEnginePass
	{
		...
		virtual void RenderSample_Stereo_GameThread(const FMoviePipelineRenderPassMetrics& InSampleState)
		{
		}
